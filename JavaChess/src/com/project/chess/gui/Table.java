...
import com.project.chess.player.ai.MiniMax;
import com.project.chess.player.ai.MoveStrategy;
...
public class Table extends Observable{
    ...
    private Table(){
         this.gameFrame = new JFrame("Java Chess Game");
    ...
    private JMenu createPreferencesMenu(){
        final JMenu preferecesMenu = new JMenu("Preferences");
        ...
        preferecesMenu.add(legalMoveHighlighterCheckbox);
    ...
    private static class TableGameAIWatcher implements Observer{
        @Override
        public void update(final Observable o, final Object arg0){
    ...
    private TakenPiecesPanel getTakenPiecePanel() {
    ...
    private static class AIThinkTank extends SwingWorker<Move, String>{
        ...
        public void done(){
            try {
                ...
                Table.get().updateGameBoard(Table.get().getGameBoard().currentPlayer().makeMove(bestMove).getTransititonBoard());
                    ...
                    if(SwingUtilities.isRightMouseButton(e)){
                        ...
                        if(sourceTile == null){
                            ...
                            if(transition.getMoveStatus().isDone()){
                                chessBoard = transition.getTransititonBoard();
            ...
            if(board.getTile(this.tileId).isTileOccupied()){               
                try {
                    final BufferedImage image = 
                            ImageIO.read(new File("art/simple/"+ board.getTile(this.tileId).getPiece().getPieceAlliance().toString().substring(0, 1)+
            ...
            if(highlightLegalMoves){
                for(final Move move : pieceLegalMoves(board)){
                    if(move.getDestinationCoordinate() == this.tileId){
                        try {
                            add(new JLabel(new ImageIcon(ImageIO.read(new File("art/misc/greendot.png")))));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
