                ...
                {authCtx.isLoggedIn && (
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto me-0 me-lg-auto fw-semibold text-uppercase">
                            ...
                            <li className="nav-item"><NavLink to="/contact" className="nav-link ">Contact Us</NavLink></li>
                            <li className="nav-item"><NavLink to="/terms" className="nav-link ">Terms & Condition</NavLink></li>
                            <li className="nav-item"><NavLink to="/stores" className="nav-link ">Neighbors</NavLink></li>
                        ...
                        <div className=" text-light fs-5 item-allign-center">
                            <div className="navbar-nav dropdown">
                                ...
                                <ul className="dropdown-menu bg-primary px-3 " aria-labelledby="navbarDropdown">
                                    <li className="mb-3"><NavLink to="/post-store" className="btn btn-outline-warning me-0 me-lg-3 mb-3 mb-lg-0 ">Add Store</NavLink></li>
