...
<nav class="navbar navbar-expand-lg header-color navbar-light">
  <div class="container-fluid">
	...
	<h1 class="d-flex justify-content-center mb-5">Send Email to User</h1>

	<div
		class="d-flex flex-wrap align-items-center justify-content-center bg-light mx-auto pt-3 pb-5 mb-5 rounded"
		style="width: 50%">
		<form method="post" class="col-8" id="bulkEmail" action="bulkEmail">
			<div class="mb-3">
			...
			<div class="mb-3">
				<label class="form-label" for="emailTo">User</label>
				<input type="text" class="form-control" name="mailto" id="mailto" placeholder="name@example.com"/>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label class="form-label" for="mailMsg" >Messages</label>
				<textarea class="form-control" name="mailMsg" id="mailMsg" rows="8"></textarea>
			</div>
			
			<button type="submit" class="btn btn-colo" id="send"name="send">Send</button>
		</form>
	</div>
